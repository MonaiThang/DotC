...
<title>New Record - Doctor on the Cloud</title>
					...
					<h:panelGrid columns="2" styleClass="form"
						...
						<h:panelGroup>
							<h:inputText id="citizenID"
								value="#{registrationBean.record.patientCitizenID}"
						...
						<h:panelGroup>
							<h:inputText id="disease"
								value="#{registrationBean.record.disease}" maxlength="45"
								size="12" />
							<f:verbatim>
								<br />
							</f:verbatim>
						...
						<h:panelGroup>
							<h:inputText id="systolic"
								value="#{registrationBean.record.systolic}" maxlength="45"
								size="12" />
							<f:verbatim>
								<br />
							</f:verbatim>
						...
						<h:outputLabel for="diastolic"
							value="#{msg.registrationDiastolic}" />
						<h:panelGroup>
							<h:inputText id="diastolic"
								value="#{registrationBean.record.diastolic}" maxlength="45"
								size="12" />
							<f:verbatim>
								<br />
							</f:verbatim>
						...
						<h:outputLabel for="breathrate"
							value="#{msg.registrationBreathrate}" />
						<h:panelGroup>
							<h:inputText id="breathrate"
								value="#{registrationBean.record.breathrate}" maxlength="45"
								size="12" />
							<f:verbatim>
								<br />
							</f:verbatim>
						...
						<h:panelGroup>
							<h:inputText id="weight"
								value="#{registrationBean.record.weight}" maxlength="45"
								size="12" />
							<f:verbatim>
								<br />
							</f:verbatim>
						...
						<h:panelGroup>
							<h:inputText id="height"
								value="#{registrationBean.record.height}" maxlength="45"
								size="12" />
							<f:verbatim>
								<br />
							</f:verbatim>
						...
						<h:panelGroup>
							<h:inputText id="symptom"
								value="#{registrationBean.record.symptom}" maxlength="45"
								size="12" />
							<f:verbatim>
								<br />
							</f:verbatim>
						...
						<h:panelGroup>
							<h:inputText id="doctorid"
								value="#{registrationBean.record.doctorID}" maxlength="45"
								size="12" />
							<f:verbatim>
								<br />
							</f:verbatim>
