...
<div class="titlesnormal">
		<div id="main">
			<h:form id="SearchPersonForm">
				<h1>Search Person</h1>
				<h:panelGroup>
					<h:panelGrid columns="10" styleClass="form"
						headerClass="tableHeader" footerClass="tableFooter"
						rowClasses="tableRowOdd, tableRowEven">
						<h:outputLabel for="CitizenID" value="Citizen ID"/>
	        			<h:inputText id="CitizenID" maxlength="32" value="#{HRBean.citizenID}"/>
	        			
		        		<h:outputLabel for="Firstname" value="First Name"/>
	        			<h:inputText id="FirstName" maxlength="50" value="#{HRBean.firstName}"/>
		        		
		        		<h:outputLabel for="Lastname" value="Last Name"/>
	        			<h:inputText id="LastName" maxlength="50" value="#{HRBean.lastName}"/>
					</h:panelGrid>
				</h:panelGroup>
				<h:panelGroup>
					<h:commandButton value="Search" type="submit" action="#{HRBean.searchPerson}" />
