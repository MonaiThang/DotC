...
<title>Registration - Doctor on the Cloud</title>
					...
					<h:panelGrid columns="2" styleClass="form"
						...
						<h:panelGroup>
							<h:inputText id="citizenID"
								value="#{registrationBean.person.citizenid}" maxlength="255"
								size="30" />
							<f:verbatim>
								<br />
							</f:verbatim>
						...
						<h:panelGroup>
							<h:inputText id="firstName"
								value="#{registrationBean.person.firstName}" maxlength="255"
								size="30" />
							<f:verbatim>
								<br />
							</f:verbatim>
						...
						<h:panelGroup>
							<h:inputText id="lastName"
								value="#{registrationBean.person.lastName}" maxlength="255"
								size="30" />
							<f:verbatim>
								<br />
							</f:verbatim>
						...
						<h:panelGroup>
							<h:selectOneMenu id="gender"
								value="#{registrationBean.person.gender}">
						...
						<h:panelGroup>
							<h:inputText id="dateOfBirth"
								value="#{registrationBean.person.dateOfBirth}">
						...
						<h:panelGroup>
							<h:inputText id="iddateissued"
								value="#{registrationBean.person.iddateissued}">
								<f:convertDateTime pattern="dd/MM/yyyy" />
							</h:inputText>
							<f:verbatim>
								<br />
						...
						<h:panelGroup>
							<h:inputText id="iddateexpired"
								value="#{registrationBean.person.iddateexpired}">
								<f:convertDateTime pattern="dd/MM/yyyy" />
							</h:inputText>
							<f:verbatim>
								<br />
						...
						<h:panelGroup>
							<h:inputSecret id="password"
								value="#{registrationBean.person.password}" maxlength="64"
						...
						<h:panelGroup>
							<h:inputText id="cline1"
								value="#{registrationBean.person.currentaddress.line1}"
						...
						<h:panelGroup>
							<h:inputText id="cline2"
								value="#{registrationBean.person.currentaddress.line2}"
								maxlength="255" size="50" />
							<f:verbatim>
								<br />
							</f:verbatim>
						...
						<h:panelGroup>
							<h:inputText id="cline3"
								value="#{registrationBean.person.currentaddress.line3}"
								maxlength="255" size="50" />
							<f:verbatim>
								<br />
							</f:verbatim>
						...
						<h:panelGroup>
							<h:inputText id="cline4"
								value="#{registrationBean.person.currentaddress.line4}"
								maxlength="255" size="50" />
							<f:verbatim>
								<br />
							</f:verbatim>
						...
						<h:panelGroup>
							<h:inputText id="cpostcode"
								value="#{registrationBean.person.currentaddress.postcode}"
						...
						<h:panelGroup>
							<h:inputText id="ccountry"
								value="#{registrationBean.person.currentaddress.country}"
						...
						<h:panelGroup>
							<h:inputText id="aline1"
								value="#{registrationBean.person.actualaddress.line1}"
								maxlength="255" size="50" />
							<f:verbatim>
								<br />
							</f:verbatim>
						...
						<h:panelGroup>
							<h:inputText id="aline2"
								value="#{registrationBean.person.actualaddress.line2}"
								maxlength="255" size="50" />
							<f:verbatim>
								<br />
							</f:verbatim>
						...
						<h:panelGroup>
							<h:inputText id="aline3"
								value="#{registrationBean.person.actualaddress.line3}"
								maxlength="255" size="50" />
							<f:verbatim>
								<br />
							</f:verbatim>
						...
						<h:panelGroup>
							<h:inputText id="aline4"
								value="#{registrationBean.person.actualaddress.line4}"
								maxlength="255" size="50" />
							<f:verbatim>
								<br />
							</f:verbatim>
						...
						<h:panelGroup>
							<h:inputText id="apostcode"
								value="#{registrationBean.person.actualaddress.postcode}"
								maxlength="50" size="50" />
							<f:verbatim>
								<br />
							</f:verbatim>
						...
						<h:panelGroup>
							<h:inputText id="acountry"
								value="#{registrationBean.person.actualaddress.country}"
								maxlength="150" size="50" />
							<f:verbatim>
								<br />
							</f:verbatim>
						...
						<h:panelGroup>
							<h:inputText id="mobile"
								value="#{registrationBean.person.mobile}" maxlength="45"
								size="20" />
							<f:verbatim>
								<br />
							</f:verbatim>
						...
						<h:panelGroup>
							<h:inputText id="emergenncycall"
								value="#{registrationBean.person.emergenncycall}" maxlength="45"
								size="20" />
							<f:verbatim>
								<br />
							</f:verbatim>
						...
						<h:panelGroup>
							<h:inputText id="career"
								value="#{registrationBean.person.career}" maxlength="45"
								size="20" />
							<f:verbatim>
								<br />
							</f:verbatim>
						...
						<h:panelGroup>
							<h:inputText id="nationality"
								value="#{registrationBean.person.nationality}" maxlength="45"
								size="20" />
							<f:verbatim>
								<br />
							</f:verbatim>
						...
						<h:panelGroup>
							<h:inputText id="religion"
								value="#{registrationBean.person.religion}" maxlength="45"
								size="20" />
							<f:verbatim>
								<br />
							</f:verbatim>
